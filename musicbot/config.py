...
class Config:
    ...
    def __init__(self, config_file: object) -> object:
        ...
        self.now_playing_mentions = config.getboolean('MusicBot', 'NowPlayingMentions',
        ...
        self.persistent_queue = config.getboolean('MusicBot', 'PersistentQueue',
